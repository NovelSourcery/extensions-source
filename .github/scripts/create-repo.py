...
IS_NOVEL_REGEX = re.compile(r"'tachiyomi.novelextension.novel' value='([^']+)'")
...
APK_BASE_URL = (
    "https://raw.githubusercontent.com/novelsourcery/extensions/refs/heads/repo/apk"
)
ICON_BASE_URL = (
    "https://raw.githubusercontent.com/novelsourcery/extensions/refs/heads/repo/icon"
)
