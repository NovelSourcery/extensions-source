 ...
 */
fun OkHttpClient.Builder.rateLimit(minimumDelayMillis: Long, permits: Int = 1): OkHttpClient.Builder = rateLimit(permits = permits, period = minimumDelayMillis.milliseconds)
