...
internal data class ExtensionMetadata(
    ...
    // Fork field: every extension in this repo is a novel source, so this is always true. Read
    // by publish-repo.py and passed through to index_pb2.Extension.isNovel (fork-reserved 8000+
    // field block in index.proto).
