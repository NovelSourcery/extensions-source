...
class WebNovelComics : HttpSource() {

    override val name = "Webnovel Comics"
    ...
    companion object {
        ...
        private const val WEBNOVEL_UPLOAD_TIME = "https://novelsourcery.github.io/webnovel-upload-time"
    }
}
